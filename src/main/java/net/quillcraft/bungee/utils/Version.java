...
public class Version {
    ...
    private enum ProtocolVersion {
        ...
        A("1.7", 3, 5), B("1.8", 47, 47), C("1.9", 107, 110), D("1.10", 210, 210), E("1.11", 315, 316), F("1.12", 335, 340), G("1.13", 393, 404), H("1.14", 477, 498), I("1.15", 573, 578), J("1.16", 735, 753), K("1.17", 755, 756), L("1.18", 757, 757);
