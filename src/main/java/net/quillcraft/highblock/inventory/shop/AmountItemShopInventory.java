...
public class AmountItemShopInventory {
    ...
    public static Inventory getAmountItemShopInventory(HighBlock skyblock, UUID playerUUID, ItemShop itemShop, int amount, int page, boolean isBuyInventory) throws SQLException {
